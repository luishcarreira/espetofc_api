...
@router.post("/", response_model=schemas_transacao.Transacao)
...
@router.get("/{transacao_id}", response_model=schemas_transacao.Transacao)
...
@router.get("/", response_model=List[schemas_transacao.Transacao])
...
@router.put("/{transacao_id}", response_model=schemas_transacao.Transacao)
...
@router.delete("/{transacao_id}", response_model=bool)
